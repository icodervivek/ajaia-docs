  ...
  return (
    <Layout>
      <div className="document-page">
        ...
        {/* key={doc.id} forces a full remount (and a fresh Tiptap instance) when
            navigating between documents client-side -- useEditor only reads its
            `content` option once, on creation, so without this a SPA navigation
            from one document to another would keep showing the previous doc's
            content. */}
        <Editor key={doc.id} content={doc.content as JSONContent} editable onChange={saveContent} />
      </div>
